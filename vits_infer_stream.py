...
if __name__ == "__main__":
    ...
    while (True):
        ...
        with torch.no_grad():
            ...
            audio = net_g.infer_stream(x_tst, x_tst_lengths, x_tst_prosody, noise_scale=0.5,length_scale=1)
        save_wav(audio, f"./vits_infer_out/bert_vits_stream_{n}.wav", hps.data.sampling_rate)
    fo.close()
